...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<ol class="breadcrumb text-left">
		  ...
		  <li class="active">Редактирование Товаров</li>
		</ol>
		<!--breadcrum end-->
				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="lead">РЕДАКТИРОВАНИЕ ТОВАРОВ</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_name" class="control-label">Название Товара *</label>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_price" class="control-label">Цена Товара ( <?php echo $row_currency["currency_code"]; ?> ) *</label>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_quantity" class="control-label">Количество в наличии *</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">       
								...
								<select class="select-simple form-control pmd-select2" name="product_status">
									<option <?php if($row['product_status'] == 'Available'){ echo 'selected';} ?> value="Available">В наличии</option>
									<option <?php if($row['product_status'] == 'Sold Out'){echo 'selected';} ?> value="Sold Out">Недоступно</option>
								</select>
							</div>
						</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="ram" class="control-label">Оперативная память *</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="processor" class="control-label">Процессор *</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="video" class="control-label">Видеокарта *</label>
								<input type="text" name="video" id="video" class="form-control" placeholder="Video" required>
							</div>
						</div>

						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="hd" class="control-label">Жесткий диск *</label>
								<input type="text" name="hd" id="hd" class="form-control" placeholder="Hd" required>
							</div>
						</div>

						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="display" class="control-label">Дисплей*</label>
								<input type="text" name="display" id="display" class="form-control" placeholder="Display" required>
							</div>
						</div>
