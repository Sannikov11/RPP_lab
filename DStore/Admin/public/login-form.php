        ...
        <div class="login-card">
            <form method="POST">  
                <div class="pmd-card-title card-header-border text-center">
                    ...
                    <div class="lead">Админ Панель</div>
                </div>
                
                <div class="pmd-card-body">
                    <?php echo isset($error['failed']) ? $error['failed'] : '';?>
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        <label for="inputError1" class="control-label pmd-input-group-label">Логин</label>
                    ...
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        <label for="inputError1" class="control-label pmd-input-group-label">Пароль</label>
                        <div class="input-group">
                ...
                <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
                    ...
                    <button type="submit" name="btnLogin" class="btn pmd-ripple-effect btn-danger btn-block">Вход</button>
                    <br>
                    <br>
                    <span class="pmd-card-subtitle-text">Sannikov Denis &copy; <span class="auto-update-year"></span></span>
            <h3 class="pmd-card-subtitle-text"><a href="https://www.youtube.com/c/ErikDeliyev" target="_blank"> Версия 2.1</a></h3>
