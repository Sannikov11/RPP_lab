				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="lead">ДОБАВИТЬ ТОВАР</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_price" class="control-label">Цена Товара ( <?php echo $row["currency_code"]; ?> ) *</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">       
								...
								<select class="select-simple form-control pmd-select2" name="product_status">
									...
									<option value="Sold Out">Недоступно</option>
								</select>
							</div>
						</div>
<!-------------------------------------------------------------------------------->
