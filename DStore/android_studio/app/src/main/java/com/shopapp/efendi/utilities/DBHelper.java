package com.shopapp.efendi.utilities;
...
/*    private final String RAM = "ram";
    ...
    public ArrayList<ArrayList<Object>> getAllData() {
        ...
        Cursor cursor = null;
        try {
            cursor = db.query(TABLE_CART, new String[]{CART_ID, PRODUCT_NAME, QUANTITY, TOTAL_PRICE, CURRENCY_CODE, PRODUCT_IMAGE,/* RAM, PROCESSOR, VIDEO, DISPLAY, HD,*/},
    ...
    public void addData(long id, String product_name, int quantity, double total_price, String currency_code, String product_image/*, String ram, String processor, String video, String display, String hd*/) {
