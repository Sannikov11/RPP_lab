...
import com.shopapp.efendi.fragments.FragmentCategory;
import com.shopapp.efendi.fragments.FragmentHelp;
import com.shopapp.efendi.fragments.FragmentProfile;
import com.shopapp.efendi.fragments.FragmentRecent;
import com.shopapp.efendi.utilities.AppBarLayoutBehavior;
...
/*Основное активити с фрагментами*/
    View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*определение тулбара и установка имени приложения в него*/
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle(R.string.app_name);//устанавливаю в тулбар имя магазина

        /*установка пейджера и его адаптера */
        viewPager = findViewById(R.id.viewpager);
        viewPager.setAdapter(new MyAdapter(getSupportFragmentManager()));
        viewPager.setOffscreenPageLimit(pager_number);

        /*вьюха для навигации между фрагментами*/
        navigation = findViewById(R.id.navigation);
        navigation.setLabelVisibilityMode(LabelVisibilityMode.LABEL_VISIBILITY_LABELED); //прочитать про визабилити
        navigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override // передаем в метод название элемента навигатора, и открываем соответствующий фрагмент (устанавливаем в пейджер номер фрагмента)
        ...
        /*устанавливаем обработчик изменения страницы (фрагмента)*/
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                //задаем название выбранного фрагмента в тулбаре
...
//        }
    ...
    public class MyAdapter extends FragmentPagerAdapter {
        ...
        @Override // метод получения фрагмента
    ...
    /*Метод для проверки решения об удалении элемента из корзины*/
...
//возвращение к первому фрагменту
    @Override
...
//выход из приложения
    ...
    //получение данных заказов (отправленных в корзину) из бд в JSON
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET, GET_TAX_CURRENCY, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    /*кнопка-элемент. Привязка и кликлисенер
                    * при нажатии на иконку корзины
                    * передается цена и код продукта*/
